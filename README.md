...
focus:
  - Fullstack web engineering (React, Node.js, PostgreSQL)
  - Real-time systems & WebSockets
  - AI integrations & RAG pipelines
  - Production deployments with Docker & Railway
...
- 🗂️ **TaskFlow** — Production Kanban SaaS with real-time collaboration, drag & drop, JWT auth and Docker deployment
- 🔬 **Thesis** — Developing & evaluating RAG pipelines for LLM performance at UMacedonia
- 🤖 **AI Copilots** — Building enterprise tools that synthesize knowledge with retrieval-augmented generation
- 🌐 **Fullstack** — End-to-end product engineering from DB schema to polished UI
...
|---|---|---|
| **[TaskFlow](https://github.com/Pliatsikas/TaskFlow)** · [🔗 Live](https://client-production-8121.up.railway.app) | Production Kanban SaaS — monorepo, REST API, JWT auth with refresh tokens, real-time drag & drop via WebSockets, deployed on Railway | `Next.js` `Node.js` `PostgreSQL` `Socket.io` `Docker` `TypeScript` |
...
`Fullstack · AI · Real-time · Production`
